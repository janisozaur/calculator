...
#define ASSERT_NEGATIVE_TESTCASES(func, dataSet)                                                                                                               \
    ...
    public:
        ...
        TEST_METHOD(ValidateExpressionRegExMatch)
        {
            ...
            VERIFY_IS_FALSE(m_CopyPasteManager.ExpressionRegExMatch(vector<wstring> {L"11111111111111111"}, ViewMode::Programmer, CategoryGroupType::Calculator,
                                                                    HexBase, QwordType));
            ...
            VERIFY_IS_TRUE(m_CopyPasteManager.ExpressionRegExMatch(vector<wstring> {L"1.23e+456"}, ViewMode::Scientific, CategoryGroupType::Calculator, -1, -1),
    ...
    ****************************************/
    ...
    void CopyPasteManagerTest::ValidateProgrammerOctPasteExpressionTest()
    {
        ...
        String ^ bytePositiveInput[] = {L"13",    L"13+46", L"1,3",   L"1 3",   L"1'2'3", L"1_2_3", L"1\"2",  L"377" /*boundary condition: max allowed number*/,
    ...
    void CopyPasteManagerTest::ValidateProgrammerBinPasteExpressionTest()
    {
        ...
        String
            ^ wordPositiveInput[] = {L"100",       L"100+101", L"1,001",      L"1 0 1",   L"1'0'0'1",         L"1_0_0_1", L"\n\r1,010\n", L"\f\n1+11\t\r\v\x85",
