...
namespace CalculatorUnitTests
{
    ...
    public:
        ...
        /// Paste tests
        ///
        template<typename T, typename Base> void ValidateIntegralsAreEqual(NumbersAndOperatorsEnum a, NumbersAndOperatorsEnum b)
        {
        ...
        TEST_METHOD(ProgrammerModeAutoConvertedValue)
        {
            ...
            TESTITEM items[] = {
                {NumbersAndOperatorsEnum::HexButton, L"0", L""}, {NumbersAndOperatorsEnum::F, L"F", L""}, {NumbersAndOperatorsEnum::None, L"", L""}};
        ...
        TEST_METHOD(ProgrammerModeNot)
        {
            ...
            m_viewModel->IsProgrammer = true;
            TESTITEM items[] = {
                {NumbersAndOperatorsEnum::One, L"1", L""}, {NumbersAndOperatorsEnum::Not, L"-2", L"~(1)"}, {NumbersAndOperatorsEnum::None, L"N/A", L"N/A"}};
            ValidateViewModelByCommands(m_viewModel, items, false);
        ...
        TEST_METHOD(OnNegativeEntryInMemory)
        {
            ...
            TESTITEM items[] = {
                {NumbersAndOperatorsEnum::One, L"1", L""},     {NumbersAndOperatorsEnum::Zero, L"10", L""},       {NumbersAndOperatorsEnum::Zero, L"100", L""},
                {NumbersAndOperatorsEnum::One, L"1,001", L""}, {NumbersAndOperatorsEnum::Negate, L"N/A", L"N/A"}, {NumbersAndOperatorsEnum::None, L"", L""},
            };
            ValidateViewModelByCommands(m_viewModel, items, true);
        ...
        TEST_METHOD(OnDecimalAddedToMemory)
        {
            ...
            TESTITEM items2[] = {
                {NumbersAndOperatorsEnum::One, L"1", L""},     {NumbersAndOperatorsEnum::Zero, L"10", L""},        {NumbersAndOperatorsEnum::Zero, L"100", L""},
                {NumbersAndOperatorsEnum::One, L"1,001", L""}, {NumbersAndOperatorsEnum::Decimal, L"1,001.", L""}, {NumbersAndOperatorsEnum::None, L"", L""},
            };
            ValidateViewModelByCommands(m_viewModel, items2, false);
            m_viewModel->OnMemoryButtonPressed();
        ...
        {
            TESTITEM items[] = {
                {NumbersAndOperatorsEnum::One, L"1", L""}, {NumbersAndOperatorsEnum::Two, L"12", L""}, {NumbersAndOperatorsEnum::None, L"", L""}};
            ValidateViewModelByCommands(m_viewModel, items, true);
