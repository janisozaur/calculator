...
namespace CalculatorApp
{
    namespace DataLoaders
    {
        ...
        public:
            ...
            IAsyncOperationWithProgress<String ^, HttpProgress> ^ GetCurrencyMetadata() override { throw ref new NotImplementedException(); }

            IAsyncOperationWithProgress<String ^, HttpProgress> ^ GetCurrencyRatios() override { throw ref new NotImplementedException(); }
        };
    }
}
...
public:
    ...
    void CurrencyDataLoadFinished(bool /*didLoad*/) override { m_task_completion_event.set(); }
...
namespace CalculatorUnitTests
{
    ...
    void InsertToLocalSettings(String ^ key, Object ^ value) { ApplicationData::Current->LocalSettings->Values->Insert(key, value); }
