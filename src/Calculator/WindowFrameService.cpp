...
namespace CalculatorApp
{
    ...
    CoreDispatcher ^ WindowFrameService::GetCoreDispatcher() { return m_coreDispatcher.Get(); }

    int WindowFrameService::GetViewId() { return m_viewId; }

    Frame ^ WindowFrameService::GetFrame() { return m_frame; }

    Page ^ WindowFrameService::GetCurrentPage() { return dynamic_cast<Page ^>(m_frame->Content); }
    ...
    bool WindowFrameService::RemoveRuntimeWindowService(TypeName serviceId) { return m_runtimeServicesMap.erase(serviceId.Name) > 0; }
