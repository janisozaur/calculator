...
namespace CalculatorManagerTest
{
    ...
    public:
        ...
        void SetMemorizedNumbers(const vector<wstring>& numbers) override { m_memorizedNumberStrings = numbers; }

        void SetParenDisplayText(const std::wstring& parenthesisCount) override { m_parenDisplay = parenthesisCount; }
        ...
        const vector<wstring>& GetMemorizedNumbers() const { return m_memorizedNumberStrings; }
        ...
        int GetBinaryOperatorReceivedCallCount() { return m_binaryOperatorReceivedCallCount; }
    ...
    void CalculatorManagerTest::CalculatorManagerTestScientific2()
    {
        ...
        Command commands20[] = {Command::Command8,      Command::CommandPWR, Command::CommandOPENP, Command::Command2,   Command::CommandDIV, Command::Command3,
                                Command::CommandCLOSEP, Command::CommandSUB, Command::Command4,     Command::CommandADD, Command::CommandNULL};
        TestDriver::Test(L"0", L"8 ^ (2 \x00F7 3) - 4 + ", commands20, true, true);

        Command commands21[] = {Command::Command4,      Command::CommandPWR, Command::CommandOPENP, Command::Command3,   Command::CommandDIV, Command::Command2,
                                Command::CommandCLOSEP, Command::CommandSUB, Command::Command8,     Command::CommandADD, Command::CommandNULL};
    ...
    void CalculatorManagerTest::CalculatorManagerTestScientificParenthesis()
    {
        ...
        Command commands4[] = {Command::Command2, Command::CommandOPENP, Command::Command2, Command::CommandCLOSEP, Command::CommandADD, Command::CommandNULL};
    ...
    void CalculatorManagerTest::CalculatorManagerTestMaxDigitsReached() { TestMaxDigitsReachedScenario(L"1,234,567,891,011,1213"); }

    void CalculatorManagerTest::CalculatorManagerTestMaxDigitsReached_LeadingDecimal() { TestMaxDigitsReachedScenario(L"0.12345678910111213"); }

    void CalculatorManagerTest::CalculatorManagerTestMaxDigitsReached_TrailingDecimal() { TestMaxDigitsReachedScenario(L"123,456,789,101,112.13"); }
